...
const currencies: ICurrency[] = [
    ...
    { id: "bitcoin", name: "Bitcoin", symbol: "BTC", type: "crypto", icon: "https://cryptologos.cc/logos/bitcoin-btc-logo.png", network: "bitcoin", contractAddress: null, minAmount: 0.0001, maxAmount: 100 },
